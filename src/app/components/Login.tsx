...
import { AlertCircle, FileText, Mail, Lock, Eye, EyeOff } from "lucide-react";
import { Alert, AlertDescription } from "./ui/alert";
import { wakeUpServices } from "../services/api"; // o donde lo pongas
            ...
            <div className="relative z-10">
              ...
              <div className="space-y-5 mb-10">
                ...
                <p className="text-lg text-white/80 leading-relaxed">
                  Crea, edita y administra documentos institucionales de manera
